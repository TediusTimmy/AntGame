...
public final class Enqueue extends StandardUnaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg) throws TypedOperationException, FatalException
    {
        ...
        else if (arg instanceof ArrayValue)
        {
            ...
            for (ValueType val : value)
            {
                ...
                {
                    throw new TypedOperationException("Enqueue called with something other than string in list of names of states.");
                }
            }
        }
        else
        {
            throw new TypedOperationException("Enqueue called without string or list of string name of state(s).");
        }
