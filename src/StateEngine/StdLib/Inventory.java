...
public final class Inventory extends StandardConstantFunction
{

    @Override
    public ValueType fun(CallingContext context)
    {
        if (null == context.cell.held)
        {
            return new StringValue("");
        }
        return new StringValue(Look.convertResourceColorToString(context.cell.held.color));
    }
