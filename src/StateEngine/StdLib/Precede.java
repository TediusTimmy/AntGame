...
public final class Precede extends StandardUnaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg) throws TypedOperationException
    {
        ...
        else if (arg instanceof ArrayValue)
        {
            ...
            for (int i = value.size() - 1; i > 0; --i)
            {
                ...
                {
                    throw new TypedOperationException("Precede called with something other than string in list of names of states.");
                }
            }
        }
        else
        {
            throw new TypedOperationException("Precede called without string or list of string name of state(s).");
        }
