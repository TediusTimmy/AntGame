...
public final class Follow extends StandardUnaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg) throws TypedOperationException
    {
        if (arg instanceof StringValue)
        {
            ...
            context.cell.machine.states.getLast().add(1, new State(state));
        }
        else if (arg instanceof ArrayValue)
        {
            ...
            for (int i = value.size() - 1; i > 0; --i)
            {
                ...
                {
                    throw new TypedOperationException("Follow called with something other than string in list of names of states.");
                }
            }
        }
        else
        {
            throw new TypedOperationException("Follow called without string or list of string name of state(s).");
        }
